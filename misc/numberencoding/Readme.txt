...
Attention: Please follow these instructions super accurately.
 ...
 - Develop the solution yourself. Do not try to find a shortcut by
   using the web.
 - Develop the solution in TypeScript using the "standard" build tool npm.
 - The core of the solution should be written without any add-ons to
   ...
   standard (e.g. you can use all features that you find in the standard
   language runtime).
   ...
   parts that use the logging library. You can also use a unit testing
   framework.
 ...
 - Your solution should contain a README.md file that explains how to
   build and run the program.
 - The interface to your program should be a command line interface similar like:
     > npm install
     > npm run build:ts
     > node dist/src/index.js ./sample-dictionary.txt ./sample-phone-number-list.txt
