...
function create(op, a, b){
    ...
    return Object.assign(
        function(){ return fn.result ??= fn() } ,
        { reset: () => delete fn.result  }
    )
}
...
const a = wires.a(); // 46065
wires['b'] = create('SET', a);
Object.values(wires).forEach(wire => wire.reset());

const result = wires.a();
console.log(result); // 14134