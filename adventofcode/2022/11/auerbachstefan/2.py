...
def new_worrylevel(monkey, old_level):
    if monkey ==0 :
        return (old_level*17) % (2*3*5*7*11*13*17*19)
    elif monkey==1:
        return (old_level+8) % (2*3*5*7*11*13*17*19)
    elif monkey==2:
        return (old_level+6) % (2*3*5*7*11*13*17*19)
    elif monkey==3:
        return (old_level*19) % (2*3*5*7*11*13*17*19)
    elif monkey==4:
        return (old_level+7) % (2*3*5*7*11*13*17*19)
    elif monkey==5:
        return (old_level*old_level) % (2*3*5*7*11*13*17*19)
    elif monkey==6:
        return (old_level+1) % (2*3*5*7*11*13*17*19)
    elif monkey==7:
        return (old_level+2) % (2*3*5*7*11*13*17*19)
